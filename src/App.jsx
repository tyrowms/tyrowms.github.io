                      ...
                      <div style={{marginLeft:'auto',display:'flex',gap:6}}>
                        ...
                        <button className="tb-b pr" onClick={()=>{
                          ...
                          const trs=pv.map((r,i)=>{
                            ...
                            const segBar='<div style="display:flex;height:11px;border-radius:5.5px;overflow:hidden;background:#eef1f6;width:130px">'+segs+'</div>';
